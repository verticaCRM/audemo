...
if($results_false_flag)
{
	...
	foreach ($results as $searchlisting){
		...
		if($searchlisting) {
		    ...
		    $html .= "			<a class='ream_est_name' href=\"/listing/". sanitize_title($searchlisting->c_name_generic_c).'--'.$searchlisting->id ."\" class=\"listing_link\" data-id=\"". $searchlisting->id ."\">".$searchlisting->c_name_generic_c."</a>";

			if(is_user_logged_in() ){
			$html .= '<form action="/listing/'.sanitize_title($searchlisting->c_name_generic_c).'--'.$searchlisting->id.'" method="post" class="listing_add_to_port_buttton">'.
		    ...
		    $html .= "			<a href=\"/listing/". sanitize_title($searchlisting->c_name_generic_c).'--'.$searchlisting->id ."\" class='real_est_description'>".$searchlisting->description."</a>";
